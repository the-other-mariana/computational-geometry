...
class BST:
	...
	def _insert(self, value, curr_node):
		if BST.isLessThan(value, curr_node.value):
		...
		elif not BST.isLessThan(value, curr_node.value):
	...
	def _search(self, value, curr_node):
		if value == curr_node.value:
			return True
		elif BST.isLessThan(value, curr_node.value) and curr_node.left_child != None:
			return self._search(value, curr_node.left_child)
		elif not BST.isLessThan(value, curr_node.value) and curr_node.right_child != None:
